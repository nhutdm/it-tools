...
monaco.editor.defineTheme('ioutils-dark', {
  base: 'vs-dark',
  inherit: true,
  rules: [],
  colors: {
...
monaco.editor.defineTheme('ioutils-light', {
  base: 'vs',
  inherit: true,
  rules: [],
  colors: {
...
watch(
  ...
  isDarkTheme => monaco.editor.setTheme(isDarkTheme ? 'ioutils-dark' : 'ioutils-light'),
  { immediate: true },
);
